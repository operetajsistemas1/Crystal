 ...
 ***************************************************************************************************/
#define M_GlcdDataBus	PORTC
#define M_GlcdDataBusDirection DDRC
#define M_GlcdDataBusInput PINC 

#define M_GlcdControlBus PORTA 
#define M_GlcdControlBusDirection DDRA 
#define M_GlcdControlBus2 PORTB
#define M_GlcdControlBusDirection2 DDRB
...
#define M_GlcdClearBit2(x)   util_BitClear((M_GlcdControlBus2),(x))
#define M_GlcdSetBit2(x)     util_BitSet((M_GlcdControlBus2),(x))
